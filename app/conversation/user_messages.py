...
ERROR_MESSAGES: dict[str, str] = {
    ...
    "AGENT_NOT_FOUND": "Non riesco ad aprire l'applicazione: il PC Agent non è online.",
    "EXECUTABLE_NOT_FOUND": "Non riesco ad aprire l'applicazione: non è disponibile sul PC.",
    "PROCESS_START_FAILED": "Non riesco ad aprire l'applicazione: avvio fallito.",
    "TOOL_EXECUTION_FAILED": "Non riesco ad aprire l'applicazione: esecuzione fallita.",
    "TOOL_EXECUTION_TIMEOUT": "Non riesco ad aprire l'applicazione: il PC Agent non ha risposto in tempo.",
